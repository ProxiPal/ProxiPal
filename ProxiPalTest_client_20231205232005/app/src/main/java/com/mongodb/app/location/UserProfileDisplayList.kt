            ...
            Box(Modifier.fillMaxSize()){
                LazyColumn(
                    ...
                    items(userProfiles) { userProfile ->
                        UserProfileCard(userProfile, onItemClick = { /*TODO*/ }, reporViewModel = reportViewModel )
...
@Composable
fun UserProfileCard(userProfile: UserProfile, onItemClick: (UserProfile) -> Unit, reporViewModel:ReportViewModel) {
    Card(
        modifier = Modifier
            .fillMaxWidth()
